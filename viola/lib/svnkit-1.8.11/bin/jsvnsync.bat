...
set CLASSPATH=
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\svnkit-1.8.11.jar"
...
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\trilead-ssh2-1.0.0-build220.jar"
...
set CLASSPATH=%CLASSPATH%;"%SVNKIT_LIB%\svnkit-cli-1.8.11.jar"
