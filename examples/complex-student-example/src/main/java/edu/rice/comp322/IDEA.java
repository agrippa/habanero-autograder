...
// byte for byte.
    ...
    long Do() throws SuspendableException
    {
...
*/
    ...
    private void cipher_idea(byte [] text1, byte [] text2, int [] key) throws SuspendableException
    {
        //omp parallel for private(i1,i2,ik,x1,x2,x3,x4,t1,t2,r)
       forallChunked(0, text1.length / 8 - 1, (i) -> {
